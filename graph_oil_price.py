...
def get_graph_oil_price(resolution, from_time, to_time):
    # Получаем данные о ценах на нефть Brent
    data = f"https://api.bcs.ru/udfdatafeed/v1/history?symbol=BRENT&resolution={resolution}&from={from_time}&to={to_time}"
    try:
